...
static void solve() {
  /*
    - If a friend pair are invited, they eat a cake together; must invite even number of pairs (inc. 0)
    - Each person is an item: (pairs_in, unhappiness)
    - Assume everyone invited; disinvite until we have m pairs invited
    - Solve for knapsack: minimal unhappiness to reach m
